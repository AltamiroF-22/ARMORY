...
export class Hero {
  /** Sets all hero elements to their hidden initial states. Call before Loader.init(). */
  prep() {
  ...
  #animateScrollIndicator() {
    gsap.to("#hero-scroll", { opacity: 1, duration: 0.8, ease: "expo.out" });
  }
